...
// Theme 1: Aurora Luxe - Ethereal northern lights with prismatic gradients
export default function HomeAuroraLuxe() {
    return (
        <div className="aurora-bg min-h-screen">
            ...
            <div className="relative z-10 mx-auto max-w-[1200px] px-4 py-8 md:px-8 lg:py-16">
                ...
                {/* Hero Section */}
                <section className="mb-24 relative overflow-hidden rounded-3xl crystal-glass">
                    <div className="absolute -right-20 -top-20 h-80 w-80 rounded-full bg-purple-500/10 blur-[100px]"></div>
                    <div className="absolute -left-10 bottom-0 h-60 w-60 rounded-full bg-cyan-400/10 blur-[80px]"></div>

                    <div className="relative z-10 flex flex-col gap-12 p-8 lg:flex-row lg:items-center lg:p-12">
                        <div className="flex flex-1 flex-col gap-8">
                            {/* Badge */}
                            <div className="badge-aurora inline-flex w-fit items-center gap-2 rounded-full px-4 py-1.5 text-xs font-bold uppercase tracking-widest backdrop-blur-sm">
                            ...
                            <h1 className="font-serif text-5xl font-extrabold leading-[1.1] tracking-wide text-white md:text-6xl lg:text-7xl">
                                Stop Overpaying.<br />
                                <span className="text-aurora-gradient">Start Maximizing.</span>
                            </h1>

                            {/* Subtitle */}
                            <p className="max-w-lg text-lg font-light leading-relaxed text-purple-200/80">
                            ...
                            <div className="flex flex-wrap gap-5 pt-2">
                                <Link
                                    to="/vouchers"
                                    className="btn-aurora-primary group relative inline-flex h-14 min-w-[180px] items-center justify-center overflow-hidden rounded-lg px-8 text-base font-bold"
                                >
                                    <span className="relative z-10">Explore Vouchers</span>
                                </Link>
                                <Link
                                    to="/calculator"
                                    className="btn-aurora-secondary inline-flex h-14 min-w-[160px] items-center justify-center gap-2 rounded-lg px-8 text-base font-medium"
                                >
                        ...
                        <div className="relative flex flex-1 items-center justify-center lg:justify-end">
                            <div className="relative h-[380px] w-full max-w-[500px] animate-premium-float">
                                <div className="prismatic-border absolute inset-0 z-0 rounded-2xl backdrop-blur-xl">
                                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div>
                                    <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-purple-500/15 blur-[60px]"></div>
                                    <div className="absolute -left-8 -bottom-8 h-32 w-32 rounded-full bg-cyan-400/15 blur-[50px]"></div>

                                    <div className="relative flex h-full flex-col justify-between p-8">
                                        <div className="flex items-start justify-between">
                                            <div className="flex items-center gap-4">
                                                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-cyan-400 shadow-lg ring-1 ring-white/20">
                                                    <img src="/assets/logo.jpg" alt="CardPerks Logo" className="h-8 w-8 object-contain rounded-sm" />
                                                </div>
                                                <div className="flex flex-col">
                                                    <span className="font-serif text-lg font-bold text-aurora-gradient tracking-wide">CardPerks</span>
                                                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-purple-300">Infinia Reserve</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="space-y-8 mt-4">
                                            <div className="group relative overflow-hidden rounded-xl border border-purple-500/20 bg-gradient-to-r from-white/5 to-white/[0.02] p-6 backdrop-blur-md transition-all hover:border-cyan-400/30">
                                                ...
                                                <div className="relative z-10 flex justify-between items-end">
                                                    <div>
                                                        <p className="text-xs font-medium uppercase tracking-wider text-purple-300/80 mb-1">Total Rewards Value</p>
                                            ...
                                            <div className="flex justify-between items-end px-1">
                                                <div className="flex flex-col gap-1.5">
                                                    <span className="text-[9px] font-bold uppercase tracking-widest text-purple-400/60">Card Holder</span>
                                                    <span className="font-mono text-sm tracking-widest text-purple-200/80">VIKRAM MEHTA</span>
                                                </div>
                                                <div className="flex flex-col gap-1.5 text-right">
                                                    <span className="text-[9px] font-bold uppercase tracking-widest text-purple-400/60">Valid Thru</span>
                                                    <span className="font-mono text-sm font-medium text-purple-200/80">09/28</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="absolute -right-6 top-20 z-10 animate-[float_4s_ease-in-out_infinite_reverse] rounded-lg border border-purple-500/30 bg-purple-900/50 p-3 shadow-xl backdrop-blur-md">
                                    <div className="flex items-center gap-3">
                                        <div className="flex h-8 w-8 items-center justify-center rounded bg-green-500/20 text-green-400">
                                            <span className="material-symbols-outlined text-[18px]">arrow_upward</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-[10px] uppercase text-purple-300/80">Marriott Bonvoy</span>
                ...
                <section className="mb-16">
                    <div className="mb-8 flex flex-col gap-2 border-b border-purple-500/20 pb-4">
                        <h2 className="font-serif text-3xl font-bold text-white">Feature Highlights</h2>
                        <p className="text-purple-200/70">Everything you need to optimize your savings in one place.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                        {[
                            ...
                            <div key={i} className="group relative overflow-hidden rounded-2xl crystal-glass p-8 transition-all hover:-translate-y-1 premium-lift">
                                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl step-aurora text-purple-300 group-hover:text-cyan-300 transition-colors duration-300">
                                ...
                                <p className="text-sm leading-relaxed text-purple-200/70 group-hover:text-purple-100">{feature.desc}</p>
                                <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-purple-500/10 blur-2xl transition-all group-hover:bg-cyan-400/15"></div>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                {/* How It Works */}
                <section className="mb-16">
                    <div className="rounded-3xl crystal-glass p-8 lg:p-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-purple-200/70 max-w-2xl mx-auto">Three simple steps to maximize your savings.</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {[
                                    ...
                                    <div key={i} className="flex flex-col items-center text-center">
                                        <div className="w-16 h-16 rounded-full step-aurora flex items-center justify-center mb-6">
                                            <span className="font-serif text-2xl font-bold text-aurora-gradient">{step.num}</span>
                                        </div>
                                        <h3 className="font-serif text-xl font-bold text-white mb-3">{step.title}</h3>
                                        <p className="text-sm text-purple-200/70 leading-relaxed">{step.desc}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <section className="mb-16">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <Link to="/guides" className="text-sm font-semibold text-cyan-400 hover:text-purple-300 transition-colors">View All</Link>
                    </div>
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row">
                        {[
                            ...
                            <div key={i} className="group flex flex-1 flex-col gap-5 rounded-2xl crystal-glass p-5 transition-all hover:border-cyan-400/30 sm:flex-row premium-lift">
                                ...
                                <div className="flex flex-col justify-center gap-3">
                                    ...
                                    <h3 className="font-serif text-xl font-bold leading-tight text-white group-hover:text-aurora-gradient transition-colors">{guide.title}</h3>
                                    <p className="line-clamp-2 text-sm text-purple-200/70">{guide.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
