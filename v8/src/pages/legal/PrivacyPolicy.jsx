                ...
                <aside className="hidden lg:block w-72 shrink-0 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto border-r border-theme-border py-8 pr-8">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1 px-3">
                            ...
                            <p className="text-accent-dim text-xs uppercase tracking-wider">Privacy Navigation</p>
                        </div>
                        ...
                        <div className="px-3 pt-6 mt-auto">
                            <div className="p-4 rounded-lg bg-theme-surface border border-theme-border">
                                <span className="material-symbols-outlined text-accent mb-2 text-[24px]">shield</span>
                                <p className="text-theme-primary text-sm font-bold mb-1">Privacy Concerns?</p>
                                <p className="text-accent-dim text-xs leading-relaxed mb-3">Contact our Data Protection Officer for any specific questions.</p>
                                <a className="text-accent-secondary text-xs font-bold hover:text-theme-primary transition-colors" href="/contact">Contact DPO →</a>
                            </div>
                        </div>
                    </div>
                </aside>
                    ...
                    <div className="mb-12 border-b border-theme-border pb-8">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                            <div className="flex flex-col gap-3 max-w-2xl">
                                <h1 className="text-accent text-4xl md:text-5xl font-serif font-black leading-tight tracking-tight">Privacy Policy</h1>
                                <p className="text-theme-primary text-lg md:text-xl font-bold leading-relaxed opacity-100">Your data stays on your device. Period.</p>
                            </div>
                    ...
                    <div className="flex flex-col gap-8">
                        {sections.map((section, idx) => (
                            <section
                                key={section.id}
                                id={section.id}
                                className="scroll-mt-24 bg-theme-surface rounded-xl p-8 md:p-10 shadow-lg border border-theme-border relative overflow-hidden group"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-baseline gap-4 mb-6 border-b border-copper/20 pb-4">
                                        <span className="text-accent-secondary font-serif text-3xl italic font-bold">{String(idx + 1).padStart(2, '0')}.</span>
                                        <h2 className="text-theme-primary text-2xl font-bold tracking-tight font-serif">{section.title}</h2>
                                    </div>
