    ...
    def handle(self, *args, **options):
        ...
        for card_data in cards_data:
            ...
            defaults = {
                ...
                # Content fields
                'verdict': card_data.get('metadata', {}).get('verdict', ''), # 'verdict' is often inside metadata in the JSON view
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully seeded cards.'))
