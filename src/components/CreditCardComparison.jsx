                            ...
                            {filters.map(filter => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: activeFilter === filter ? 'rgba(6, 182, 212, 0.1)' : 'transparent',
                                    ...
                                    >
                                        ...
                                        <div
                                            style={{
                                                ...
                                                backgroundColor: isSelected ? 'var(--accent-cyan)' : 'rgba(0,0,0,0.3)',
                                                display: 'flex',
                                                alignItems: 'center',
                                        ...
                                        <div style={{ height: '140px', marginBottom: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#1a1a2e', borderRadius: '12px', overflow: 'hidden', padding: '10px' }}>
                                            <img src={card.image} alt={card.name} style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }}
                                                onError={(e) => { e.target.style.display = 'none'; e.target.parentElement.style.background = '#333'; e.target.parentElement.innerHTML = `< span style = "color:#666;font-size:12px" > ${card.name}</span > `; }}
                                            />
                                        </div>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <img
                                src={modalCard.image}
                                alt={modalCard.name}
                                style={{ maxWidth: '200px', maxHeight: '130px', objectFit: 'contain' }}
                            />
                        </div>
