                                    ...
                                    >
                                        ...
                                        <div className="item-details">
                                            <div className="item-name-row">
                                                ...
                                                {['iShop', 'Maximize', 'Gyftr', 'MagicPin', 'SaveSage', 'Magnify'].some(p => platform.name.toLowerCase().includes(p.toLowerCase())) && (
                                ...
                                <div key={idx} className={`platform-row ${isBest ? 'best' : ''}`}
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                        ...
                                        <div>
                                            ...
                                            {['iShop', 'Maximize', 'Gyftr', 'Magnify'].some(p => platform.name.toLowerCase().includes(p.toLowerCase())) && (
                                                <div style={{
